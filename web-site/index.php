...
<meta name="description" content="Our Family is best platform for crowdfunding in India. Raise online funds for your problem through fundraising in India. ✯ Quick Fundraising ✯ Global Donors" />
<meta name="keywords" content="Crowdfunding india, crowdfunding in india, crowdfunding, crowdfunding website, crowdfund, crowdsourcing, ourfamily, crowdsourcing platform, fundraising, Medical crowdfunding, Medical fundraising" />
<meta name="author" content="OurFamily" />

<!-- Page Title -->
<title>Our Family: Crowdfunding India | Best Crowdfunding Platform in India</title>
...
<div id="side-panel" class="dark" data-bg-img="images/bg/bg8.jpg">
  <div class="side-panel-wrap">
    ...
    <a href="javascript:void(0)"><img alt="logo" src="images/ourfamily_logo.png"></a>
    <div class="clearfix"></div>
    <div class="side-panel-widget mt-30">
      <div class="widget no-border">
        <ul>
          <li class="font-14 mb-5"> <i class="fa fa-phone text-theme-colored"></i> <a href="#" class="text-gray">+91 993-391-6543</a> </li>
          <li class="font-14 mb-5"> <i class="fa fa-clock-o text-theme-colored"></i> Mon-Fri 8:00 to 2:00 </li>
          <li class="font-14 mb-5"> <i class="fa fa-envelope-o text-theme-colored"></i> <a href="#" class="text-gray">ourfamily@gmail.com</a> </li>
        </ul>      
      </div>
      <br>
      ...
      <p>Copyright &copy;2019 OurFamily</p>
...
<div id="wrapper" class="clearfix">
  ...
  <!-- Modal -->
  <div class="modal fade" id="donateModel" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>If you want to donate? please make payment to bellow Account.</p>
          <p>Account Number- 3194560894 </p>
          <p>Name- Sarojit Samuel</p>
          <p>IFSC- SBIN0000160</p>
          <p>For more enquery please call us on <b>(+91) 993 3916 543 </b>.</p>
        </div>
        ...
        <div class="rev_slider_wrapper">
          <div class="rev_slider" data-version="5.0">
            <ul>
              ...
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="images/bg/bg1.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-theme-colored font-raleway"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:800;">Help Poor
                </div>
                ...
                <div class="tp-caption tp-resizeme" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-flat btn-sm btn-theme-colored" href="#" data-toggle="modal" data-target="#donateModel">Donate Now</a>
                </div>
              </li>

              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="images/bg/medicalhelp2.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/medicalhelp2.jpg"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-theme-colored font-raleway pl-40 pr-40"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:800; border-radius:45px;">Medical Help 
                </div>
                ...
                <div class="tp-caption tp-resizeme" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-sm btn-flat btn-theme-colored" href="#" data-toggle="modal" data-target="#donateModel" >Donate Now</a>
                </div>
              </li>

              <!-- SLIDE 3 -->
              <li data-index="rs-3" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="images/bg/marriage.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/marriage.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-theme-colored font-raleway"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:800;">Marriage 
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            ...
            <h2 class="title text-theme-colored mt-0">Our Family</h2>
            <p class="mb-10">Our family is an online crowd funding system which enables everyone to help and support each other.</p>
            <p class="mb-10">The main objective of our family is to add 70% to 80% household of India who do not have financial flexibility to reunite their families and bring a chance by providing financial stability to their families.</p>

            <h4 class="mt-20 mb-5">Key Areas:-</h4>
            <ul class="list theme-colored angle-double-right mb-sm-30">
              <li><a href="#">Providing medical treatment to those who are deprived of treatment due to their weak economic base.</a></li>
              <li><a href="#">Providing financial aid to those families for their daughter’s marriage.</a></li>
              <li><a href="#">Assisting meritorious student to pursue their higher education who cannot afford the same.</a></li>
            </ul>
          </div>
          <div class="col-md-5">
            <div class="thumb mt-5">
              <img alt="" src="images/blog/2.jpg" class="img-fullwidth">
            </div>
            <h4 class="mt-20 mb-5">Our Mission</h4>
            <p>The main objective of our family is to add 70% to 80% household of India who do not have financial flexibility to reunite their families and bring a chance by providing financial stability to their families.</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row mtli-row-clearfix">
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
              <div class="thumb">
                <img class="img-fullwidth" alt="" src="images/project/medical-help.jpg">
              </div>
              ...
              <div class="causes-details clearfix border-bottom p-15 pt-10">
                <h5><a href="#">Providing medical help</a></h5>
                <p>Lorem ipsum dolor sit amet, consect adipisicing elit. Praesent quos sit.</p>
                <ul class="list-inline clearfix mt-20">
                  <li class="pull-left pr-0">Raised: &#8377; 800</li>
                  <li class="text-theme-colored pull-right pr-0">Goal:  &#8377; 10500</li>
                </ul>
                <div class="mt-10">
                 <a class="btn btn-dark btn-theme-colored btn-flat btn-sm pull-left mt-10" href="#" data-toggle="modal" data-target="#donateModel">Donate</a>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
              <div class="thumb">
                <img class="img-fullwidth" alt="" src="images/project/financial-help.jpg">
              </div>
              <div class="progress-item mt-0">
                <div class="progress mb-0">
              ...
              <div class="causes-details clearfix border-bottom p-15 pt-10">
                <h5><a href="#">Providing financial aid</a></h5>
                <p>Lorem ipsum dolor sit amet, consect adipisicing elit. Praesent quos sit.</p>
                <ul class="list-inline clearfix mt-20">
                  <li class="pull-left pr-0">Raised: &#8377; 18090</li>
                  <li class="text-theme-colored pull-right pr-0">Goal: &#8377; 2500</li>
                </ul>
                <div class="mt-10">
                 <a class="btn btn-dark btn-theme-colored btn-flat btn-sm pull-left mt-10" href="#" data-toggle="modal" data-target="#donateModel">Donate</a>
                 <div class="pull-right mt-15"><i class="fa fa-heart-o text-theme-colored"></i> 2 Donors</div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
              <div class="thumb">
                <img class="img-fullwidth" alt="" src="images/project/education-help.jpg">
              </div>
              <div class="progress-item mt-0">
                <div class="progress mb-0">
              ...
              <div class="causes-details clearfix border-bottom p-15 pt-10">
                <h5><a href="#">Providing help for Education</a></h5>
                <p>Lorem ipsum dolor sit amet, consect adipisicing elit. Praesent quos sit.</p>
                <ul class="list-inline clearfix mt-20">
                  <li class="pull-left pr-0">Raised: &#8377; 18090</li>
                  <li class="text-theme-colored pull-right pr-0">Goal: &#8377; 2500</li>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
            <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
              <div class="thumb">
                <img class="img-fullwidth" alt="" src="images/project/marriage-help.jpg">
              </div>
              <div class="progress-item mt-0">
                <div class="progress mb-0">
              ...
              <div class="causes-details clearfix border-bottom p-15 pt-10">
                <h5><a href="#">Financial help for marriage</a></h5>
                <p>Lorem ipsum dolor sit amet, consect adipisicing elit. Praesent quos sit.</p>
                <ul class="list-inline clearfix mt-20">
        ...
        <div class="section-content text-center">
          <div class="row">
            <div class="col-md-12">
              ...
              <h2>Just call at <span class="text-theme-colored">(+91) 993 3916 543</span> to make a donation</h2>
            </div>
          </div>
        </div>
      </div>      
          ...
          <div class="row multi-row-clearfix">
            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/team/ganesh_kumbhakar.jpeg" class="img-fullwidth"  ></div>
                <div class="info">
                  <h4 class="name"><a href="#">Ganesh Kumbhakar</a></h4>
                  <h6 class="occupation">Social Service</h6>
            ...
            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/team/somnath_sarkar.jpeg" class="img-fullwidth"></div>
                <div class="info">
                  <h4 class="name"><a href="#">Somnath Sarkar</a></h4>
                  <h6 class="occupation">Social Service</h6>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit dictum nobis.</p>
                  <hr>
                  <ul class="styled-icons icon-sm icon-dark icon-theme-colored mt-10 mb-0">
            ...
            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/team/boby_ara.jpeg" class="img-fullwidth"></div>
                <div class="info">
                  <h4 class="name"><a href="#">Boby Ara</a></h4>
                  <h6 class="occupation">Social Service</h6>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit dictum nobis.</p>
                  <hr>
                  <ul class="styled-icons icon-sm icon-dark icon-theme-colored mt-10 mb-0">
            ...
            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
              <div class="volunteer border bg-white-fa maxwidth400 p-30">
                <div class="thumb"><img alt="" src="images/team/zarina_bagem.jpeg" class="img-fullwidth"></div>
                <div class="info">
                  <h4 class="name"><a href="#">Zarina Bagem</a></h4>
                  <h6 class="occupation">Social Service</h6>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit dictum nobis.</p>
                  <hr>
                  <ul class="styled-icons icon-sm icon-dark icon-theme-colored mt-10 mb-0">
    ...
    <!-- divider: Donate Now -->
    <section class="divider parallax" data-stellar-background-ratio="0.4"  data-bg-img="images/bg/bg7.jpg">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="gallery-isotope grid-7 gutter-small clearfix" data-lightbox="gallery">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images/gallery/gallery-sm13.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images/gallery/gallery-sm14.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images/gallery/gallery-sm15.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images/gallery/gallery-sm16.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images/gallery/gallery-sm17.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images/gallery/gallery-sm18.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images/gallery/gallery-sm19.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
            ...
            <article class="post clearfix maxwidth600 mb-sm-30">
              ...
              <div class="entry-content border-1px p-20">
                ...
                <ul class="list-inline entry-date pull-right font-12 mt-5">
                  ...
                  <li><span class="text-theme-colored">Nov 12, 2019</span></li>
                </ul>
                <div class="clearfix"></div>
              </div>
            </article>
          ...
          <div class="col-md-4">
            <article class="post clearfix maxwidth600 mb-sm-30">
              ...
              <div class="entry-content border-1px p-20">
                ...
                <ul class="list-inline entry-date pull-right font-12 mt-5">
                  <li><a class="text-theme-colored" href="#">Admin |</a></li>
                  <li><span class="text-theme-colored">Nov 19, 2019</span></li>
                </ul>
                <div class="clearfix"></div>
              </div>
            </article>
          ...
          <div class="col-md-4">
            <article class="post clearfix maxwidth600 mb-sm-30">
              ...
              <div class="entry-content border-1px p-20">
                ...
                <ul class="list-inline entry-date pull-right font-12 mt-5">
                  <li><a class="text-theme-colored" href="#">Admin |</a></li>
                  <li><span class="text-theme-colored">Nov 15, 2019</span></li>
                </ul>
                <div class="clearfix"></div>
              </div>
            </article>
...
<script type="text/javascript" src="js/revolution-slider/js/extensions/revolution.extension.video.min.html"></script>
