      ...
      <form class="login-form" action="" method="post">
        <div class="row">
          <div class="input-field col s12 center">
            <p class="center login-form-text"><?= isset($msg)? $msg:'OurFamily';?></p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="input-field col s12">            
            <button name="adminLogin" class="btn waves-effect waves-light col s12">Login</button>
          </div>
        </div>
      </form>
      <p>If you are not a Member Yet?  </p>
      <p>Plaese Call: <b>(+91) 993 3916 543</b></p>
      <p><a href="../web-site">Go Back To Web-Site?</a></p>
    </div>
  </div>
