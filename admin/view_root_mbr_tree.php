  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <?php include_once('left_asid.php');
         $decodeRootId=base64_decode($_GET['rmID']);
       ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          Root Member Tree List            
          </h1>
          <ol class="breadcrumb">
            <li><a href="dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="obycs_vsa">Root Member Tree List</a></li>
            <li class="active">View Root Member Tree List </li>
          </ol>
        </section>
            ...
            <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">				  
                    ...
                    <tbody>
                      <?php                      
                       foreach ($object->findRootMembersTree($decodeRootId) as $rc => $rMbrDta) {
